...
![A screenshot of the text editor.](./img/welcome.PNG)
![A screenshot of the text editor.](./img/working.PNG)
...
- Terminal doesn't work ATM.
- Help tab doesn't do anything ATM.
- The program doesn't verify that you've made a change to the original file, so when quitting, it'll ask to save but it won't do anything atm.
